...
-- 2、任务调度表增加一列环境
-- ----------------------------
ALTER TABLE task_scheduling ADD IF NOT EXISTS env_name VARCHAR(255) COMMENT '测试环境';
-- ----------------------------
-- 3、公共参数表增加一列环境
-- ----------------------------
ALTER TABLE project_case_params ADD IF NOT EXISTS env_name VARCHAR(255) COMMENT '测试环境';
-- ----------------------------
...
-- 4、新建聚合计划表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `project_suite` (
...
-- 5、新建计划关系表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `project_suite_plan` (
...
-- 6、调度任务表添加两列
-- ----------------------------
ALTER TABLE task_scheduling ADD IF NOT EXISTS suite_id int COMMENT '聚合计划ID';
ALTER TABLE task_scheduling ADD IF NOT EXISTS plan_type int DEFAULT 1 COMMENT '计划类型 1 单个计划 2聚合计划';
UPDATE task_scheduling SET plan_type=1 where plan_type=0;
-- ----------------------------
-- 7、任务执行表添加一列
-- ----------------------------
ALTER TABLE task_case_execute ADD IF NOT EXISTS plan_id int DEFAULT NULL COMMENT "计划ID";
-- ----------------------------
-- 8、修改plan_id默认为null
-- ----------------------------
...
-- 10、插入菜单
-- ----------------------------
INSERT IGNORE INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `url`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`)
...
-- ----------------------------
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(1,1110);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(1,1111);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(1,1112);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(1,1113);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(1,1114);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(2,1110);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(2,1111);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(2,1112);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(2,1113);
INSERT IGNORE INTO sys_role_menu(role_id,menu_id) VALUES(2,1114);